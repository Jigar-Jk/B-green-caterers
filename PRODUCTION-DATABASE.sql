-- B Green Caterers Database Schema - PRODUCTION
-- Admin Dashboard Menu Management

CREATE DATABASE IF NOT EXISTS u412954154_bgreencaterers CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE u412954154_bgreencaterers;
...
INSERT IGNORE INTO menu_items (category_id, name, description, price, image_url, is_chefs_pick, is_popular, display_order) VALUES
